...
import { PAYMENT_PROVIDER } from './domain/providers/i-payment-provider'
...
@Module({
  ...
  providers: [
    ...
    // sem MP_ACCESS_TOKEN cai no provider fake (dev), igual ao ConsoleMailProvider
    {
      provide: PAYMENT_PROVIDER,
      useClass: process.env.MP_ACCESS_TOKEN ? MercadoPagoProvider : FakePaymentProvider,
    },
